...
library(karyoploteR)
  ...
  dg2 <- read.table(gzfile(paste0("../output/GWAS/",trait,"/ukb_EUR_",trait,"_t100k.pval.regenie")),header=F)
  ...
  pdf(paste0("../output/figs/mirror_",trait,".pval.pdf"), width = 20, height = 4)
  ...
  kpAddLabels(kp, labels = paste0("GWAS \n -log10P"), srt=90, pos=3, r0=0, r1=0.5, cex=1, label.margin = 0.04)
